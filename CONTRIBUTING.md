# Contributing to AumAI Dhansetu
...
### Setup
```bash
git clone https://github.com/aumai/aumai-dhansetu.git
cd aumai-dhansetu
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-dhansetu/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-dhansetu/discussions)
